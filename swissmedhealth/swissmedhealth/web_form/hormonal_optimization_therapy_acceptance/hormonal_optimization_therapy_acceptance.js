	...
	$('.submit-btn').on('click', function (e) {
		...
		frappe.call('swissmedhealth.swissmedhealth.web_form.gdpr_consent.gdpr_consent.save', { doc: frappe.web_form.doc }).then(() => {
			frappe.msgprint({
				title: __('Success'),
				indicator: 'green',
				message: __('We have successfully received your form. A member of our professional team will be in touch with you shortly to discuss the next steps. Thank you!!!')
			});
